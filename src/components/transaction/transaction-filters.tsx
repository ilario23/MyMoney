    ...
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between pb-3 border-b border-border/30">
        ...
        <span className="text-xs text-muted-foreground">
          {resultCount}{" "}
          {resultCount === 1
            ? t("transactions.filters.results")
            : t("transactions.filters.resultsPlural")}
        </span>
      </div>
      ...
      <div className="space-y-4">
              ...
              <div className="absolute top-full left-0 right-0 mt-1 z-50 border border-border/30 bg-background rounded-lg shadow-lg max-h-48 overflow-y-auto">
                {categoryList.length === 0 ? (
                  <div className="p-3 text-xs text-muted-foreground italic">
                    {t("transactions.filters.noCategoriesAvailable")}
                  </div>
                ) : (
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="date">
                  {t("transactions.filters.sortDate")}
                </SelectItem>
                <SelectItem value="amount">
                  {t("transactions.filters.sortAmount")}
                </SelectItem>
                <SelectItem value="category">
                  {t("transactions.filters.sortCategory")}
                </SelectItem>
              </SelectContent>
            </Select>
        ...
        {hasActiveFilters && onSaveFilter && (
          <div className="space-y-2 border-t pt-4">
            <label className="text-xs font-semibold uppercase text-muted-foreground">
              {t("transactions.filters.saveFilter")}
            </label>
            <div className="flex gap-2">
              <Input
                placeholder={t("transactions.filters.filterName")}
