...
export function Navigation() {
  ...
  const navItems = [
    ...
    { path: '/expenses', icon: Receipt, label: t('nav.expenses'), special: false },
    { path: '/groups', icon: Users, label: t('nav.groups'), special: false },
    { path: '/profile', icon: Settings, label: t('nav.profile'), special: false },
  ];
